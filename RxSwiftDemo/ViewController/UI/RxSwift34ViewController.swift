//
//  RxSwift34ViewController.swift
//  RxSwiftDemo
//
//  Created by Kystar's Mac Book Pro on 2021/6/7.
//
...
class RxSwift34ViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        Observable.of(refreshCommand, addCommand, movedCommand, deleteCommand)
            ...
            .share(replay: 1)
            .bind(to: tableView.rx.items(dataSource: RxSwift34ViewController.dataSource()))
...
extension RxSwift34ViewController {
    //创建表格数据源

...
class RxSwift53ViewController: BaseViewController {
    ...
    //显示资源列表的tableView
        ...
        override func viewDidLoad() {
            ...
            //初始化ViewModel
            let viewModel = RxSwift53ViewModel(searchAction: searchAction)
            ...
            //单元格点击
            tableView.rx.modelSelected(RxSwift53GitHubRepository.self)
